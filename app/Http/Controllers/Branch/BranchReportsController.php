...
{
    $this->assertBranch(); // or $this->branchShopOrFail() (use your existing guard)
    ...
    /**
     * ✅ Qty subquery: SUM(sale_items.quantity) per sale
     */
    ...
    /**
     * ✅ Payment info (most recent payment)
     */
    ...
    return view('panels.branch.reports.sales', compact('sales', 'totals', 'profit', 'banks'));
}
}
