...
<div class="grid">
    <div class="col-12 card">
        <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; flex-wrap:wrap;">
            <div>
                <h1 class="h1">My Branch Staff</h1>
                <p class="muted">Manage staff accounts for your branch only.</p>
            </div>
            <a class="btn" href="{{ route('branch.staff.create') }}">+ Add Staff</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:10px; border-bottom:1px solid rgba(255,255,255,0.06);">
                            <form method="POST" action="{{ route('branch.staff.toggle', $s->id) }}">
                                @csrf
