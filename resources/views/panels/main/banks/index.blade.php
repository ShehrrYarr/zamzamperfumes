    ...
    <div class="col-12 card">
        <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;">
            <div>
                ...
                <p class="muted">These banks will appear in POS when payment method = Bank.</p>
            </div>
            <a class="btn" href="{{ route('main.banks.create') }}">+ Add Bank</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:10px; border-bottom:1px solid rgba(255,255,255,0.06);">
                            <a class="btn btn-ghost" href="{{ route('main.banks.edit', $b->id) }}">Edit</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
