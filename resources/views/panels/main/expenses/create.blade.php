        ...
        <div class="card" style="max-width:900px;">
            <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;">
                <div>
                    ...
                    <p class="muted">Record any expense made by the shop.</p>
                </div>
                <a class="btn btn-outline-secondary" href="{{ route('main.expenses.index') }}">← Back</a>
            </div>
            ...
            <form class="mt-3" method="POST" action="{{ route('main.expenses.store') }}">
                @csrf
                ...
                <div style="display:flex;gap:10px;flex-wrap:wrap;">
                    ...
                    <a class="btn btn-outline-secondary" href="{{ route('main.expenses.index') }}">Cancel</a>
                </div>
            </form>
        </div>
    </div>
