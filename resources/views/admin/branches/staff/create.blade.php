    ...
    <div class="col-12 card">
        <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:12px; flex-wrap:wrap;">
            <div>
                ...
                <p class="muted">Creates a staff login for this branch.</p>
            </div>
            <a class="btn btn-ghost" href="{{ route('admin.branches.staff.index', $shop->id) }}">← Back</a>
        </div>
        ...
        <form method="POST" action="{{ route('admin.branches.staff.store', $shop->id) }}"
            ...
            <div style="display:flex; gap:10px; flex-wrap:wrap;">
                ...
                <a class="btn btn-ghost" href="{{ route('admin.branches.staff.index', $shop->id) }}">Cancel</a>
            </div>
        </form>
    </div>
</div>
