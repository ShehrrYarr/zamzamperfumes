...
<div class="grid">
    <div class="col-12 card">
        <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; flex-wrap:wrap;">
            <div>
                <h1 class="h1">Staff — {{ $shop->name }}</h1>
                <p class="muted">Manage staff accounts for this branch.</p>
            </div>
            <div style="display:flex; gap:10px; flex-wrap:wrap;">
                <a class="btn btn-ghost" href="{{ route('admin.branches.index') }}">← Back</a>
                <a class="btn" href="{{ route('admin.branches.staff.create', $shop->id) }}">+ Add Staff</a>
            </div>
        </div>
