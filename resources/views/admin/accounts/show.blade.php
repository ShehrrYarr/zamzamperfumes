    ...
    <div class="col-12 card">
        <div style="display:flex;justify-content:space-between;gap:12px;flex-wrap:wrap;align-items:center;">
            <div>
                ...
                <p class="muted">
                    {{ strtoupper($account->shop?->type ?? '') }} — {{ $account->shop?->name }}
                </p>
            </div>
            <a class="btn btn-outline-secondary" href="{{ route('admin.accounts.index') }}">← Back</a>
        </div>
        ...
        <form method="GET" class="row">
            ...
            <div class="col-md-4 mb-2 d-flex align-items-end">
                ...
                <a class="btn btn-outline-secondary" href="{{ route('admin.accounts.show', $account->id) }}">Reset</a>
            </div>
        </form>
        ...
        <form method="POST" action="{{ route('admin.accounts.entries.store', $account->id) }}" class="row">
            @csrf
